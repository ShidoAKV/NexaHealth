...
const Videocall = () => {
 ...
 console.log('====================================');
    ...
    const toggleAudio = () => setOpen(!open);
    ...
    return (
        <div className="flex flex-col lg:flex-row-reverse items-center p-5 gap-6 min-h-screen bg-gray-100">
            {/* Remote Video Section */}
            <div className="w-full lg:w-[900px] h-[500px] relative">
                <video
                    ref={remoteVideoRef}
                    autoPlay
                    playsInline
                ...
                />
                <div className="bg-black flex items-center p-2 rounded-b-md">
                    {open ? (
                        <FaVolumeMute
                            onClick={toggleAudio}
                            className="text-white bg-blue-500 hover:bg-blue-700 w-10 h-8 p-1 rounded-xl cursor-pointer"
                        />
                    ) : (
                        <VscUnmute
                            onClick={toggleAudio}
            ...
            <div className="flex flex-col items-center lg:items-start gap-6  w-full lg:w-[350px]">
                
                <div className="flex gap-2 w-full sm:pt-9 lg:pt-0">
                    <input
                        type="text"
                ...
                <div className="w-full text-center">
                    <h2 className="text-md font-semibold">Joining ID:</h2>
