...
const Assistance = () => {
  ...
  return (
    <div className="fixed md:static w-screen lg:w-[100%] top-0 left-0 z-40 flex flex-col min-h-screen text-white bg-black/90">
      {/* Sidebar */}
      <div
      ...
      >
        ...
        <div className="hidden md:flex  border-b border bg-neutral-900 overflow-hidden items-center gap-2 p-4  ">
      ...
      {/* Chat Section */}
      <div className="flex-1 flex flex-col border-l border overflow-hidden md:ml-[250px]">
        <div
        ...
        >
          {messages.map((msg, index) => (
            <div key={index} className="flex items-start gap-2">
              ...
              <div
                className={`p-3 rounded-lg max-w-lg whitespace-pre-line ${msg.sender === 'user' ? 'bg-blue-500' : 'bg-gray-700'
                  }`}
              >
                {msg.text}
              </div>
        ...
        {/* Input Section */}
        <div className="p-4 border-t  border-gray-700 flex items-center bg-black sticky bottom-0 z-50">
          <input
            type="text"
